 ...
 * 
 * RubyMenu hỗ trợ thêm nhận biết menu level1, menu level2... bằng cách thêm `{ns}menu-lv1` class
 * vào menu <ul> đầu tiên
 */

/**
 * VẤN ĐỀ CẦN GIẢI QUYẾT
 * !!!! Tính toán lại cách thêm class `{ns}menu-lv#` vào Menu, hỗ trợ cho Wordpress
 */
;(function($) {
'use strict';
  ...
  M = {
    ...
    AddClass : function() {
      ...
      var fnMenuLevel = function($parent, selector, classes) {
        ...
        if( $ul.length ) $ul.addClass( M.NS(classes) );
        return $ul;
      };

      var $menuLv1 = fnMenuLevel($ruby, '> .{ns}menu, .{ns}menu-lv1', '{ns}menu {ns}menu-lv1');
      var $menuLv2 = fnMenuLevel($menuLv1, '> li > .{ns}menu, > li > ul', '{ns}menu {ns}menu-lv2');
      var $menuLv3 = fnMenuLevel($menuLv2, '> li > .{ns}menu, > li > ul', '{ns}menu {ns}menu-lv3');
       ...
       */
      // var $lists = fnMenuLevel($ruby, '.{ns}menu > li', '{ns}list');
      var $listLv1 = fnMenuLevel($menuLv1, '> li', '{ns}list {ns}list-lv1');
      var $listLv2 = fnMenuLevel($menuLv2, '> li', '{ns}list {ns}list-lv2');
      var $listLv3 = fnMenuLevel($menuLv3, '> li', '{ns}list {ns}list-lv3');
